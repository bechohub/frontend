...
export default function Home() {
  ...
  return (
    <div
      className="min-h-screen bg-black text-[#f0f0fa] font-sans overflow-x-hidden"
      ref={containerRef}
    >
      <Navbar />
        ...
        <section className="py-24 bg-black border-y border-zinc-900 relative z-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              <FadeIn>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-4 text-white">
                  Every Business is <span className="text-zinc-600">Verified.</span><br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { icon: ShieldCheck, title: "Verified Suppliers", desc: "Rigorous KYC & active verification. No shell companies." },
                { icon: CheckCircle2, title: "Verified Buyers", desc: "High intent, financially vetted procurement teams." },
                { icon: Key, title: "Secure Escrow", desc: "Your capital is locked safely until fulfillment." },
                { icon: FastForward, title: "Faster Closures", desc: "From RFQ to PO in days, not months. Zero friction." }
              ].map((item, i) => (
                <FadeIn key={i} delay={i * 0.1} className="h-full">
                  <div className="h-full p-8 border border-zinc-800 bg-zinc-950/30 flex flex-col items-start hover:bg-zinc-900/50 hover:border-zinc-700 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-black uppercase tracking-widest mb-4 text-white">{item.title}</h3>
                    <p className="text-zinc-500 font-medium text-sm tracking-wide leading-relaxed">{item.desc}</p>
                  </div>
                </FadeIn>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
              ...
              <FadeIn>
                <div className="space-y-12">
                  <div className="border-b-2 border-zinc-900 pb-8">
                    <div className="text-cyan-700 text-sm font-black tracking-[0.3em] uppercase mb-4">Command Center</div>
                    <h3 className="text-5xl font-black uppercase tracking-tighter text-white">For Buyers</h3>
                  </div>
                  <div className="space-y-10">
                    {[
                      { step: "01", title: "Post Requirement", desc: "Define your specs in under 30 seconds." },
                      { step: "02", title: "Get Verified Suppliers", desc: "Smart matching brings the best directly to you." },
                      { step: "03", title: "Close Deal Securely", desc: "Execute contracts and pay via built-in Escrow." }
                    ].map((item, i) => (
                      <div key={i} className="flex gap-8 items-start group">
                        <span className="text-4xl font-black text-zinc-800 group-hover:text-cyan-600 transition-colors leading-none">{item.step}</span>
                        <div>
                          <h4 className="text-xl font-bold uppercase tracking-widest mb-3 text-white">{item.title}</h4>
              ...
              <FadeIn delay={0.2}>
                <div className="space-y-12">
                  <div className="border-b-2 border-zinc-900 pb-8">
                    <div className="text-cyan-700 text-sm font-black tracking-[0.3em] uppercase mb-4">Sales Engine</div>
                    <h3 className="text-5xl font-black uppercase tracking-tighter text-white">For Sellers</h3>
                  </div>
                  <div className="space-y-10">
                    {[
                      { step: "01", title: "Get High-Intent Buyers", desc: "No spam. Only verified RFQs with real intent score." },
                      { step: "02", title: "Send Quotes Fast", desc: "Quick quote system baked right in to your dashboard." },
                      { step: "03", title: "Get Paid Securely", desc: "Funds held in Escrow. Zero default risk on payouts." }
                    ].map((item, i) => (
                      <div key={i} className="flex gap-8 items-start group">
                        <span className="text-4xl font-black text-zinc-800 group-hover:text-cyan-600 transition-colors leading-none">{item.step}</span>
                        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-900 border border-zinc-900">
              <FadeIn className="bg-black">
                <div className="p-12 md:p-16 h-full">
                  ...
                  <ul className="space-y-8">
                    {["Spam buyer leads & unqualified RFQs", "Zero trust or physical verification", "Endless non-transparent price wars", "No payment security or legal cover", "Weeks of follow-ups to finalize a deal"].map((text, i) => (
                      <li key={i} className="flex items-start gap-5 text-zinc-500 font-medium tracking-wide text-lg">
              ...
              <FadeIn delay={0.2} className="bg-black">
                <div className="p-12 md:p-16 relative overflow-hidden h-full">
                  ...
                  <h3 className="text-3xl font-black uppercase tracking-widest text-white mb-12 flex items-center gap-4 relative z-10">
                    <span className="text-cyan-600">✓</span> BechoHub Way
                  </h3>
                  <ul className="space-y-8 relative z-10">
                    {["Verified buyers only, intent scored", "Smart matchmaking by precise spec", "Premium pricing protected by Escrow", "100% Secure payments and legal cover", "Deals close in 48 hours autonomously"].map((text, i) => (
                      <li key={i} className="flex items-start gap-5 text-white font-bold tracking-wide text-lg">
        ...
        <section className="py-32 bg-black border-t border-zinc-900">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20">
              <div>
                <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-4 text-white">Commodities.</h2>
                <p className="text-zinc-500 tracking-[0.2em] uppercase font-bold text-sm">Deep liquidity in strategic sectors</p>
              </div>
              <Link href="/categories" className="group text-cyan-600 font-bold uppercase tracking-[0.2em] text-sm hover:text-white flex items-center gap-3 mt-8 md:mt-0 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FadeIn>
                <Link href="/category/tea" className="group block relative h-[600px] md:h-[700px] border border-zinc-800 hover:border-zinc-500 transition-colors duration-500 overflow-hidden bg-zinc-950">
                  <Image 
                  ...
                  <div className="absolute bottom-0 left-0 p-12 w-full">
                    <div className="flex justify-between items-end">
                      <div>
                        <h3 className="text-5xl font-black uppercase tracking-wider mb-4 text-white group-hover:text-cyan-500 transition-colors duration-500">Tea</h3>
                        <p className="text-zinc-400 font-bold tracking-[0.2em] uppercase text-sm">CTC, Orthodox, Green • Bulk Trade</p>
                      </div>
              ...
              <FadeIn delay={0.2}>
                <Link href="/category/textile" className="group block relative h-[600px] md:h-[700px] border border-zinc-800 hover:border-zinc-500 transition-colors duration-500 overflow-hidden bg-zinc-950">
                  <Image 
                  ...
                  <div className="absolute bottom-0 left-0 p-12 w-full">
                    <div className="flex justify-between items-end">
                      <div>
                        <h3 className="text-5xl font-black uppercase tracking-wider mb-4 text-white group-hover:text-cyan-500 transition-colors duration-500">Textile</h3>
                        <p className="text-zinc-400 font-bold tracking-[0.2em] uppercase text-sm">Yarn, Fabric, Garments • Bulk Trade</p>
                      </div>
                      <div className="w-12 h-12 rounded-full border border-zinc-700 flex flex-col justify-center items-center group-hover:bg-cyan-600 group-hover:border-cyan-600 transition-colors duration-500">
                         <ArrowRight className="text-white w-5 h-5 -rotate-45 group-hover:rotate-0 transition-transform duration-500" />
                      </div>
        ...
        <section className="py-32 bg-zinc-950 border-y border-zinc-900 relative">
          <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-16 md:gap-8">
            <FadeIn className="text-center md:text-left w-full border-b border-zinc-800 pb-16 md:border-b-0 md:pb-0 md:border-r md:pr-8">
              <h3 className="text-7xl md:text-8xl lg:text-[120px] font-black text-white mb-4 tracking-tighter leading-none">500<span className="text-cyan-700">+</span></h3>
              <p className="text-zinc-500 font-bold uppercase tracking-[0.3em] text-sm text-balance">Verified Suppliers</p>
            </FadeIn>
            <FadeIn delay={0.1} className="text-center md:text-left w-full border-b border-zinc-800 pb-16 md:border-b-0 md:pb-0 md:border-r md:px-8">
              <h3 className="text-7xl md:text-8xl lg:text-[120px] font-black text-white mb-4 tracking-tighter leading-none">₹X <span className="text-4xl md:text-6xl text-cyan-700">Cr+</span></h3>
              <p className="text-zinc-500 font-bold uppercase tracking-[0.3em] text-sm text-balance">Trade Enabled</p>
            </FadeIn>
            <FadeIn delay={0.2} className="text-center md:text-left w-full md:pl-8">
              <h3 className="text-7xl md:text-8xl lg:text-[120px] font-black text-white mb-4 tracking-tighter leading-none">100<span className="text-cyan-700">%</span></h3>
              <p className="text-zinc-500 font-bold uppercase tracking-[0.3em] text-sm text-balance">Secure Trades</p>
            </FadeIn>
          </div>
        </section>
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center">
            <FadeIn>
              <h2 className="text-5xl md:text-7xl lg:text-[100px] font-black tracking-tighter uppercase mb-16 leading-[0.85] text-white">
                START YOUR <br className="hidden md:block"/>FIRST DEAL <span className="text-cyan-600 block sm:inline">TODAY.</span>
              </h2>
