...
const roles = [
  {
    ...
    title: "Buyer",
    icon: (
      <svg className="w-8 h-8 mb-2 text-blue-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.35 2.7A2 2 0 0 0 7.48 19h9.04a2 2 0 0 0 1.83-3.3L17 13M7 13V6h13" /></svg>
    ),
  ...
  },
  {
    ...
    title: "Seller",
    icon: (
      <svg className="w-8 h-8 mb-2 text-green-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4z" /></svg>
    ),
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {roles.map(r => (
            ...
            >
              ...
              <button className={`w-full py-2 rounded font-semibold ${r.key === "buyer" ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-green-600 text-white hover:bg-green-700"}`}>{r.btn}</button>
            </div>
          ))}
        </div>
      </div>
